...
# other declarations
	sourcePath = "/global-manager/api/v1/global-infra/domains/" + domainID + "/groups/" + sourcedata
	destinationPath = "/global-manager/api/v1/global-infra/domains/" + domainID + "/groups/" + destinationdata
	servicePath = "/global-manager/api/v1/global-infra/domains/" + domainID + "/services/" + servicedata
...
# If multiple entries exists check if each entry is valid and combine to array
			...
			destinationentry = destinationPath
